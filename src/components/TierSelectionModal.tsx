...
export const TierSelectionModal: React.FC<TierSelectionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-md max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingTiers.map((tier) => {
              ...
              return (
                <div
                  key={tier.id}
                  className={`relative bg-gray-50 rounded-md p-6 transition-all duration-300 hover:shadow-md ${
                    tier.popular
