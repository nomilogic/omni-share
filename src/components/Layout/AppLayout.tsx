...
=======
                                style={{ color: "#6B5CA8" }}
                              >
                                {user.wallet.package.coins ?? 0}/25,000
>>>>>>> Stashed changes
                              </p>
                            </div>
...
=======
                                <svg
                                  ...
                                  className="w-5 h-5"
                                >
                                  <path d="M4 12a2 2 0 114 0 2 2 0 01-4 0zm12-8a2 2 0 114 0 2 2 0 01-4 0zm0 16a2 2 0 114 0 2 2 0 01-4 0zM6 12h12m-2-8l-8 8m8 0l-8 8" />
                                </svg>
>>>>>>> Stashed changes
                                Referral Coins
                                <span
...
=======
                            style={{ borderColor: "#6B5CA8", color: "#6B5CA8" }}
>>>>>>> Stashed changes
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
