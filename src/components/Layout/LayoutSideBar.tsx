...
import { Menu, X, LogOut, Gift } from "lucide-react";
  ...
  `}
      >
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="text-center flex flex-col items-center justify-center border-y gap-3 border-white/20 relative p-2">
            <div className="flex justify-center space-x-3 md:text-xs text-sm theme-text-light mb-1">
              <Link
                to="/privacy"
      ...
      <div className="fixed top-0 z-10 w-full overflow-hidden border-b border-white/20 md:px-4 py-4  px-3 bg-white h-[60px]">
        <div className=" flex items-center justify-between mt-0 ">
          ...
          <Link to="/dashboard" className="-ml-[73px] absolute  left-[50%] ">
                                ...
                                <div className="relative" ref={referralRef}>
                                  <button
                                    onClick={(e: any) => {
                                      ...
                                      e.preventDefault();
                                      e.nativeEvent.stopImmediatePropagation();
                                      setReferralMsgOpen((prev: any) => !prev);
                                    }}
                                    className="text-slate-300 text-xs cursor-pointer"
                                  >
                                    <Icon name="question-mark" size={17} />
