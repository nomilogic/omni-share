...
const profileFormConfig = [
  {
    ...
    fields: [
      { name: 'fullName', label: 'Full Name', type: 'text', placeholder: 'e.g. Sarah Ahmed', required: true },
      { name: 'email', label: 'Email Address', type: 'email', placeholder: 'e.g. sarah@brandstudio.com', required: true },
      { name: 'phoneNumber', label: 'Phone Number (optional)', type: 'tel', placeholder: 'e.g. +971 50 123 4567', required: false }
    ]
  },
  {
    id: 'brand',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'checkbox-group',
        options: ['Professionals', 'Students', 'Entrepreneurs', 'Families', 'Influencers'],
        required: false
      }
    ]
  },
    ...
    fields: [
      {
        ...
        type: 'checkbox-group',
        options: ['Instagram', 'LinkedIn', 'TikTok', 'YouTube', 'Facebook', 'Pinterest'],
        required: false
      },
      {
        ...
        type: 'tags',
        placeholder: 'e.g. Technology, Lifestyle, Fashion, Travel, Food & Beverage',
        required: false
      }
    ]
  },
    ...
    fields: [
      {
        ...
        type: 'checkbox-group',
        options: ['Build personal brand', 'Promote business', 'Share expertise', 'Showcase work', 'Sell products/services', 'Stay connected'],
        required: false
      },
      {
        name: 'keyOutcomes',
        ...
        type: 'checkbox-group',
        options: ['Increase followers', 'Drive website traffic', 'Generate leads/sales', 'Boost engagement', 'Build community', 'Gain credibility'],
        required: false
      },
      {
        name: 'postingStyle',
        ...
        type: 'select',
        options: ['Informative', 'Entertaining', 'Inspirational', 'Conversational', 'Mixed'],
        required: false
      }
    ]
  }
