...
function ReferralSection() {
  ...
  const referralLink = 'https://omnishare.ai/auth?referralId=25803be2-d178-48e9-8631-d73b042f6dee';
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-4">
      <div className="grid md:grid-cols-2  items-center">
        <div>
          <h2 className="text-4xl font-bold text-[#7650e3] mb-4">Refer & Earn!</h2>
          <p className="text-gray-700 mb-8 text-sm leading-relaxed">
            When someone buys a package using your referral link, you both earn 100 Buses Coins!
          </p>

          <div className="mb-6">
            <label className="text-xs text-gray-600 mb-2 block font-medium">Copy Link or Share Below</label>
