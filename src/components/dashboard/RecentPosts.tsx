  ...
  return (
    <div className="bg-gray-100 rounded-md p-5 flex flex-col h-[450px] w-full">
      ...
      <button
        ...
        className="w-full text-white py-2.5 px-4 rounded-md font-semibold text-md transition-all   bg-[#7650e3] hover:bg-[#d7d7fc] hover:text-[#7650e3] hover:border-[#7650e3] mt-4"
      >
        {t("create_post")}
      </button>
    </div>
