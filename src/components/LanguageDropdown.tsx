  ...
  return (
    ...
    >
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((v) => !v)}
        className={` w-[80px] p-0.5 rounded-md text-sm bg-white/10 hover:bg-white/20 border border-white/20 flex justify-center items-center  transition-all ${
          className ?? ""
        }`}
      >
      ...
      {open && (
        <div
          role="menu"
          className={`mt-2 w-[80px] bg-white rounded-md shadow-lg z-50 overflow-hidden ${
