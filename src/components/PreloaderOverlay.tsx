...
export const PreloaderOverlay: React.FC<PreloaderOverlayProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      {/* Loading container */}
      <div className="relative z-10 bg-gray-900/95 backdrop-blur-md border border-white/20 rounded-md md:p-8 p-6 max-w-md w-full mx-4 shadow-md animate-slideUp">
        {/* Cancel button */}
        ...
        <div className="absolute inset-0 overflow-hidden rounded-md pointer-events-none">
          ...
          />
          <div
            className="absolute -bottom-10 -left-10 w-20 h-20 bg-purple-500/10 rounded-full animate-ping"
            style={{ animationDuration: "4s", animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-emerald-500/5 rounded-full animate-pulse"
