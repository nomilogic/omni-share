...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section id="video" className="py-8 md:py-14 bg-white relative overflow-hidden">
        <motion.div
          className="absolute inset-0 opacity-5"
      ...
      <div className="relative bg-theme-secondary ">
        ...
        >
               {" "}
          {/* MAIN WRAPPER: Contains the copyright, links, AND social icons */} 
             {" "}
          <div className="w-full mx-auto pt-2 md:px-[10%] px-3 flex flex-col sm:flex-row items-center md:justify-between gap-3">
            ...
                {/* 3. Social Media Icons - **NOW INTEGRATED** */}       {" "}
