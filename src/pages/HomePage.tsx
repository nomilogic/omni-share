            ...
            <AnimatePresence>
              {Cookies.get("auth_token") && (
                <motion.div
                  ...
                  className="border-b border-white/20 p-2 overflow-hidden"
                >
                  <button
                    onClick={() => {
                      setIsMenuOpen(false);
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center  mb-2 md:mb-8"
          >
  ...
  >
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <motion.div
          className="absolute bottom-14 md:bottom-16 flex justify-center left-0 right-0 transform "
          animate={{ y: [0, 10, 0] }}
      ...
      <section className="py-8 md:py-14 bg-gradient-to-br from-[#d7d7fc] to-white relative overflow-hidden md:px-10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 ">
          ...
          <div className="relative pb-8 md:px-4">
            ...
            <motion.button
              onClick={prevReview}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 bg-white rounded-full p-3 shadow-xl hover:shadow-2xl transition-all z-20"
              whileHover={{
            ...
            <motion.button
              onClick={nextReview}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 bg-white rounded-full p-3 shadow-xl hover:shadow-2xl transition-all z-20"
              whileHover={{
                boxShadow: "0 20px 40px rgba(0, 0, 0, 0.25)",
                scale: 1.1,
              }}
              ...
              >
                ...
                <AnimatePresence>
                  {expandedFaqIndex === index && (
                    ...
                    >
                      <div className="px-6 pb-5 text-gray-500 text-lg leading-relaxed ">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
