...
export async function generateImage(
  ...
  try {
    ...
    switch (request.style) {
      case "professional":
        enhancedPrompt +=
          ", professional business style, clean, corporate, high-quality";
        break;
      case "artistic":
        enhancedPrompt +=
          ", artistic style, creative, visually appealing, aesthetic";
        break;
      case "cartoon":
    ...
    switch (request.aspectRatio) {
      ...
      case "9:16":
        enhancedPrompt +=
          ", portrait orientation, vertical format, mobile-friendly";
        break;
      default:
    ...
    const { width, height } =
      dimensions[request.aspectRatio as keyof typeof dimensions] ||
      dimensions["1:1"];
